...
<a href="/newEvento.php" class="btn btn-primary" style="color: white;">Novo Evento</a>
...
<table class="table" style="color: #0595a9;">
    ...
    ?>
        ...
        <td>
            <a href="/newEvento.php?idEvento=<?php echo $row->id; ?>&Titulo=<?php echo $row->Titulo; ?>&Descricao=<?php echo $row->Descricao; ?>" class="btn btn-warning">Atualizar</a>
